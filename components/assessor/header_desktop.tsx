    ...
    <header className="hidden md:flex items-center justify-between bg-[#142B4D] px-8 py-4 shadow-md text-white">
      ...
      <nav className="flex items-center space-x-8 text-sm font-semibold">
        ...
        <Link
          ...
          className={`relative py-1 transition-colors duration-200 hover:text-white after:absolute after:bottom-0 after:left-0 after:h-[2px] after:transition-all after:duration-300 ${
            isActive('/admin/assessor/perpanjangan')
              ? 'text-white after:w-full after:bg-white'
              : 'text-slate-300 after:w-0 after:bg-white hover:after:w-full'
          }`}
        >
      ...
      <div className="flex items-center space-x-5">
        <Link
          ...
          className={`p-2 rounded-full transition-colors flex items-center justify-center relative group ${isActive('/admin/assessor/notification') ? 'bg-slate-700' : 'hover:bg-slate-700/50'
            }`}
        >
          <img
        ...
        <Link
          ...
          className={`w-10 h-10 rounded-full overflow-hidden flex items-center justify-center font-bold text-sm border-2 transition-all hover:scale-105 ${isActive('/admin/assessor/profile')
