                ...
                <div key={file.id} className="flex items-center justify-between gap-2 bg-emerald-50 dark:bg-emerald-950/20 p-1.5 rounded border border-emerald-200 dark:border-emerald-900/40">
                  ...
                  <div className="flex gap-1.5 items-center">
                    ...
                    <button 
                      ...
                      className="p-1 rounded bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 shadow-sm text-red-650 hover:bg-red-50 dark:hover:bg-red-955/30 hover:border-red-300 transition-all"
                      title="Delete File"
                    >
