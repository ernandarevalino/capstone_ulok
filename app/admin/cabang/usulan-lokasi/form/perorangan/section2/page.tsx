      ...
      <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-xl bg-gray-50/60 dark:bg-gray-800/15 border border-gray-200 dark:border-gray-800 animate-fadeIn">
              ...
              <div className="md:col-span-2 pt-2 border-t border-gray-200 dark:border-gray-800 mt-1">
                <UploadSlot
                  ...
                  label={`Dokumen Scan Buku Sertifikat (${jenisAlasHak})`}
                  subLabel="Unggah berkas halaman penuh buku sertifikat asli"
            ...
            {isLainnya && (
              <div className="space-y-4 pt-2 pl-6 border-l-2 border-blue-950/30 dark:border-gray-700 animate-fadeIn">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  ...
                  <UploadSlot
                    docType="ajb_girik"
                    label="Dokumen Berkas AJB"
                    subLabel="Format PDF scan lengkap"
                    uploadedDocs={uploadedDocs}
                    isPending={isPending}
                    handleFileUpload={handleFileUpload}
                    handleMultipleFileUpload={handleMultipleFileUpload}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  <UploadSlot
                    docType="surat_tidak_sengketa"
                    label="Surat Keterangan Tidak Sengketa TTD Lurah & Camat"
                    subLabel="Format PDF"
                    uploadedDocs={uploadedDocs}
                    isPending={isPending}
                    handleFileUpload={handleFileUpload}
                  ...
                  />
                  <UploadSlot
                    docType="surat_riwayat_tanah"
                    label="Surat Keterangan Riwayat Tanah TTD Lurah & Camat"
                    subLabel="Format PDF"
                    uploadedDocs={uploadedDocs}
                    isPending={isPending}
                    handleFileUpload={handleFileUpload}
                  ...
                  />
                  <UploadSlot
                    docType="surat_penguasaan_fisik"
                    label="Surat Penguasaan Fisik Bidang Tanah TTD Lurah & Camat"
                    subLabel="Format PDF"
                    uploadedDocs={uploadedDocs}
                    isPending={isPending}
                    handleFileUpload={handleFileUpload}
                  ...
                  />
                  <UploadSlot
                    docType="berita_acara_pengukuran"
                    label="Berita Acara Pengukuran & Gambar Ukur TTD Lurah & Camat"
                    subLabel="Format PDF"
                    uploadedDocs={uploadedDocs}
                    isPending={isPending}
                    handleFileUpload={handleFileUpload}
                ...
                <div className="border border-gray-200 dark:border-gray-800 rounded-xl p-3 bg-white dark:bg-[#111827] space-y-3 shadow-sm">
                  ...
                  {isProsesSertifikat && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 pt-1 pl-4 border-l-2 border-red-200 dark:border-red-900/40 animate-fadeIn">
                      <UploadSlot
                        docType="covernote_notaris"
                        label="Covernote Notaris"
                        subLabel="Kondisional proses"
                        uploadedDocs={uploadedDocs}
                        isPending={isPending}
                        handleFileUpload={handleFileUpload}
                        handleMultipleFileUpload={handleMultipleFileUpload}
                      ...
                      />
                      <UploadSlot
                        docType="tanda_terima_bpn"
                        label="Tanda Terima BPN"
                        subLabel="Kondisional proses"
                        uploadedDocs={uploadedDocs}
                        isPending={isPending}
                        handleFileUpload={handleFileUpload}
                      ...
                      />
                      <UploadSlot
                        docType="surat_perintah_setor"
                        label="Surat Perintah Setor"
                        subLabel="Kondisional proses"
                        uploadedDocs={uploadedDocs}
                        isPending={isPending}
                        handleFileUpload={handleFileUpload}
        ...
        <div className="bg-white dark:bg-[#111827] border border-gray-300 dark:border-gray-800 rounded-xl p-5 space-y-4 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 pt-2">
            <UploadSlot
              docType="sppt_pbb"
              label="SPPT PBB Terbaru"
              subLabel="Scan lembar pajak tahunan"
              uploadedDocs={uploadedDocs}
              isPending={isPending}
              handleFileUpload={handleFileUpload}
              handleMultipleFileUpload={handleMultipleFileUpload}
            ...
            <UploadSlot
              docType="stts_pbb"
              label="STTS PBB (Bukti Bayar)"
              subLabel="Tanda terima bayar pajak"
              uploadedDocs={uploadedDocs}
              isPending={isPending}
              handleFileUpload={handleFileUpload}
              handleMultipleFileUpload={handleMultipleFileUpload}
            ...
            <UploadSlot
              ...
              subLabel="Surat izin mendirikan bangunan"
              uploadedDocs={uploadedDocs}
              isPending={isPending}
              handleFileUpload={handleFileUpload}
              handleMultipleFileUpload={handleMultipleFileUpload}
            ...
            <UploadSlot
              ...
              subLabel="Surat kelayakan gedung"
              uploadedDocs={uploadedDocs}
              isPending={isPending}
              handleFileUpload={handleFileUpload}
              handleMultipleFileUpload={handleMultipleFileUpload}
            ...
            />
            <UploadSlot
              docType="izin_tetangga"
              label="Izin Lingkungan / Tetangga"
              subLabel="Format PDF / TTD warga"
              uploadedDocs={uploadedDocs}
              isPending={isPending}
              handleFileUpload={handleFileUpload}
              handleMultipleFileUpload={handleMultipleFileUpload}
            ...
            />
            <UploadSlot
              docType="persetujuan_developer"
              label="Surat Persetujuan Developer"
              subLabel="Wajib jika di kawasan Perumahan"
              uploadedDocs={uploadedDocs}
              isPending={isPending}
              handleFileUpload={handleFileUpload}
              handleMultipleFileUpload={handleMultipleFileUpload}
        ...
        <div className="bg-white dark:bg-[#111827] border border-gray-300 dark:border-gray-800 rounded-xl p-5 space-y-4 shadow-sm">
          ...
          {isJaminan === 'Ya' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-xl bg-gray-50 dark:bg-gray-800/15 border border-gray-200 dark:border-gray-800 animate-fadeIn">
              ...
              <UploadSlot
                docType="surat_persetujuan_bank"
                label="Surat Persetujuan Resmi Bank"
                subLabel="Scan dokumen persetujuan agunan bank"
                uploadedDocs={uploadedDocs}
                isPending={isPending}
                handleFileUpload={handleFileUpload}
                handleMultipleFileUpload={handleMultipleFileUpload}
        ...
        <div className="bg-white dark:bg-[#111827] border border-gray-300 dark:border-gray-800 rounded-xl p-5 space-y-3 shadow-sm">
          ...
          <div className="pt-2">
            <UploadSlot
              docType="dokumen_tambahan"
              label="Dokumen Berkas Pendukung Tambahan Lainnya"
              subLabel="Format berkas bebas gabungan"
              uploadedDocs={uploadedDocs}
              isPending={isPending}
              handleFileUpload={handleFileUpload}
              handleMultipleFileUpload={handleMultipleFileUpload}
