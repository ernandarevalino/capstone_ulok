  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-slate-50 to-slate-100 p-6 text-gray-800">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        {/* HEADER */}
        <div className="bg-linear-to-r from-blue-950 via-slate-900 to-blue-950 text-white p-8 rounded-3xl shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden">
