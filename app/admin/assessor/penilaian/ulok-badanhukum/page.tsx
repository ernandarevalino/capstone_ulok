...
import { DetailPenilaianBadanHukumClient } from './DetailPenilaianBadanHukumClient'

export default async function DetailPenilaianBadanHukumPage({
  searchParams,
}: {
  ...
  return (
    <DetailPenilaianBadanHukumClient
      ulokId={ulokId}
