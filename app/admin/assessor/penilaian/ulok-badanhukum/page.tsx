...
export default function DetailPenilaianBadanHukumPage() {
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6 space-y-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-3">
            <h2 className="font-bold text-gray-800 text-base flex items-center gap-2">
              <span>🏢</span> Informasi Usulan Kelompok Badan Hukum (Read-Only)
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <label className="block text-xs font-bold text-gray-400 mb-1">Status Kepemilikan (Khusus Badan Hukum)</label>
              <input 
                type="text"
                value={statusBadan}
                readOnly
