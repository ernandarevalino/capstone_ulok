...
export default function Section2BadanHukumAssessorPage() {
      ...
      <div className="border p-3 rounded-xl bg-white space-y-1.5 shadow-sm">
        ...
        {existingDoc ? (
          <div className="flex items-center justify-between gap-2 bg-green-50 p-2 rounded-lg border border-green-200">
            <span className="text-[10px] font-medium text-green-700 truncate max-w-[90px]">Sudah Diunggah</span>
            <div className="flex gap-1.5 items-center">
              <a href={existingDoc.file_url} target="_blank" rel="noopener noreferrer" className="text-[10px] bg-blue-950 text-white px-2 py-1 rounded font-bold hover:bg-blue-900 transition shadow-sm flex items-center h-[26px]">
                👁️ Lihat
              </a>
              <button
                type="button"
          ...
          <div className="space-y-1 bg-gray-50 p-2 rounded-lg border border-dashed border-gray-300">
            <p className="text-[10px] text-gray-400 font-bold">⚠️ Belum ada berkas</p>
            <p className="text-[9px] text-gray-400 font-medium">{hint}</p>
          </div>
        )}
      </div>
    )
          ...
          {jenisAlasHak !== '' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-xl bg-gray-50/60 border border-gray-200">
              ...
              <div>
                ...
                <input type="text" readOnly value={noSertifikat} className="w-full border p-2 bg-gray-100 rounded-lg text-xs cursor-not-allowed outline-none text-gray-500" />
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-600 mb-1">Nama Pemegang Hak</label>
                <input type="text" readOnly value={namaSertifikat} className="w-full border p-2 bg-gray-100 rounded-lg text-xs cursor-not-allowed outline-none text-gray-500" />
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-600 mb-1">Luas Tanah (m²)</label>
                <input type="number" readOnly value={luasSertifikat} className="w-full border p-2 bg-gray-100 rounded-lg text-xs cursor-not-allowed outline-none text-gray-500" />
              </div>
              ...
              <div className="md:col-span-2 pt-2 border-t mt-1">
                {renderUploadSlot("sertifikat_tanah", `Dokumen Scan Buku Sertifikat (${jenisAlasHak})`, "Halaman penuh buku sertifikat")}
              </div>
            </div>
          )}
              ...
              <div className="space-y-4 pt-2 pl-6 border-l-2 border-blue-950/30">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div>
                    ...
                    <input type="text" readOnly value={namaAjbLainnya} className="w-full border p-2 bg-gray-100 rounded-lg text-xs cursor-not-allowed outline-none text-gray-500" />
                  </div>
                  <div>
                    <label className="block text-[11px] font-bold text-gray-500 mb-1">No. & Luas Objek AJB</label>
                    <input type="text" readOnly value={noAjbLainnya} className="w-full border p-2 bg-gray-100 rounded-lg text-xs cursor-not-allowed outline-none text-gray-500" />
                  </div>
