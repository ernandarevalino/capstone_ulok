...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0B1329] text-gray-800 dark:text-gray-100 transition-colors duration-500 flex flex-col justify-between overflow-x-hidden selection:bg-[#142B4D]/30 scroll-smooth">
      ...
      <nav className={`sticky top-0 z-50 w-full transition-all duration-300 border-b ${scrolled
        ...
        <div className={`md:hidden absolute top-20 left-0 w-full bg-white dark:bg-[#0B1329] border-b border-gray-200 dark:border-gray-800/80 transition-all duration-300 ease-in-out ${mobileMenuOpen ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-4 invisible pointer-events-none'
          }`}>
      ...
      <header className="relative min-h-[calc(100vh-5.5rem)] flex flex-col justify-center items-center pt-8 pb-24 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8 relative z-10 my-auto">
          ...
          <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed font-medium">
            <strong className="text-gray-900 dark:text-white">PRISMA</strong> (Platform Rekomendasi dan Integrasi Sewa Mitra Alfamidi) menjembatani digitalisasi berkas legalitas dan perhitungan kelayakan usulan lokasi toko Alfamidi berdasarkan sistem penunjang keputusan.
          </p>
      ...
      <footer className="py-8 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0B1329] text-center text-xs text-gray-400 dark:text-gray-500 font-semibold tracking-wide">
        &copy; {currentYear} PRISMA (Platform Rekomendasi dan Integrasi Sewa Mitra Alfamidi) ALFAMIDI - Sistem Penunjang Keputusan Pemrosesan Dokumen ULOK
      </footer>
