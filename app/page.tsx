...
const CRITERIA_CARDS = [
  {
    ...
    typeColor: 'text-[#3365A6] dark:text-[#F28705]',
    badgeBg: 'bg-[#3365A6]/10 dark:bg-[#F28705]/10 text-[#3365A6] dark:text-[#F28705]',
    iconContainer: 'bg-[#3365A6]/10 dark:bg-[#F28705]/10 text-[#3365A6] dark:text-[#F28705]',
    desc: 'Persentase kesesuaian berkas berdasarkan status pemilik hak berupa badan hukum atau perorangan.',
    weight: '45% (0.45)',
    weightColor: 'text-[#3365A6] dark:text-[#F28705]'
  },
  {
    id: 'C2',
    icon: Scale,
  ...
  return (
    <div className="min-h-screen bg-[#F2F2F2] dark:bg-[#0D0D0D] text-[#0D0D0D] dark:text-[#F2F2F2] transition-colors duration-200 ease-in-out flex flex-col justify-between overflow-x-hidden selection:bg-[#3365A6]/30 scroll-smooth">
      ...
      <div className="hidden md:block dark:hidden fixed inset-0 pointer-events-none overflow-hidden z-0">
        ...
        <div className="absolute -top-32 -left-32 w-[600px] h-[600px] bg-[#3365A6]/35 rounded-full blur-[130px] animate-pulse" />

        {/* Blob 2: Merah PRISMA (Bottom-Right) */}
        <div className="absolute -bottom-32 -right-32 w-[600px] h-[600px] bg-[#D91E2E]/30 rounded-full blur-[130px] animate-pulse [animation-delay:1.5s]" />

        {/* Blob 3: Kuning PRISMA (Center Accent) */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#F28705]/25 rounded-full blur-[120px] animate-pulse [animation-delay:3s]" />

        {/* Blob 4: Biru PRISMA (Top-Right) */}
        <div className="absolute -top-20 -right-20 w-[450px] h-[450px] bg-[#3365A6]/25 rounded-full blur-[110px] animate-pulse [animation-delay:2s]" />

        {/* Blob 5: Merah PRISMA (Bottom-Left) */}
        <div className="absolute -bottom-20 -left-20 w-[450px] h-[450px] bg-[#D91E2E]/25 rounded-full blur-[110px] animate-pulse [animation-delay:2.5s]" />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="block md:hidden p-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-200/50 dark:hover:bg-slate-800/50 transition-colors focus:outline-none"
          ...
          <div className="px-6 py-4 flex flex-col gap-4">
            {NAV_LINKS.map((link) => (
              <a
                ...
                className="text-base font-semibold text-slate-600 dark:text-slate-400 hover:text-[#3365A6] dark:hover:text-[#F28705] transition-colors py-1"
              >
                {link.label}
              </a>
            ))}
      ...
      <header className="relative min-h-[calc(100vh-5rem)] flex flex-col justify-center items-center py-10 sm:py-16 lg:py-24 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-[#3365A6]/10 dark:bg-[#F28705]/5 blur-[80px] sm:blur-[120px] rounded-full -z-10 animate-pulse" />
